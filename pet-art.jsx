...
const PETS = {
  poppy:  { name: 'Poppy',  breed: 'Mixed (Dalmatian × Setter)', shortBreed: 'Mixed', age: '2y',   gender: 'F', weight: '38 lb', dist: '2.4 mi', fee: 350, shelter: 'Willow Creek Rescue', kind: 'dog',    color: '#FFD6B5', accent: '#FF8466', Art: Pet_Poppy,
    bio: "A spotty whirlwind who loves long hikes and short naps. House-trained, kid-tested, snore-certified.",
    traits: ['Energetic', 'Kid-safe', 'Crate-trained', 'Loves walks'] },
  miso:   { name: 'Miso',   breed: 'Longhair', shortBreed: 'Longhair', age: '4y', gender: 'M', weight: '11 lb', dist: '1.9 mi', fee: 180, shelter: 'Rose City Cat Rescue', kind: 'cat', color: '#F2D5B0', accent: '#E8A47C', Art: Pet_Miso,
    bio: "Self-appointed window supervisor. Will rotate between four favorite sunbeams and judge them gently.",
    traits: ['Calm', 'Lap cat', 'Apartment-OK', 'Vaccinated'] },
  clover: { name: 'Clover', breed: 'Holland Lop', shortBreed: 'Rabbit', age: '1y', gender: 'F', weight: '3 lb', dist: '3.0 mi', fee: 95, shelter: 'Willow Creek Rescue', kind: 'rabbit', color: '#E8D5F5', accent: '#A48EE5', Art: Pet_Clover,
    bio: "Tiny but opinionated. Has thoughts about romaine, parsley, and whoever is standing too close to the carrot drawer.",
    traits: ['Litter-trained', 'Bonded pair OK', 'Indoor', 'Quiet'] },
  olive:  { name: 'Olive',  breed: 'Beagle mix', shortBreed: 'Beagle', age: '1y', gender: 'F', weight: '22 lb', dist: '3.1 mi', fee: 250, shelter: 'Pearl District', kind: 'dog', color: '#D4E4C4', accent: '#7BA66B', Art: Pet_Olive,
    bio: "Nose first, brain second. A very good girl who has Big Plans for every shrub on the block.",
    traits: ['Sniffer', 'Friendly', 'Dog-social', 'Treat-motivated'] },
  pepper: { name: 'Pepper', breed: 'Terrier mix', shortBreed: 'Mixed', age: '7y', gender: 'M', weight: '24 lb', dist: '4.8 mi', fee: 150, shelter: 'Willow Creek Rescue', kind: 'dog', color: '#D6DCEA', accent: '#6E7FB0', Art: Pet_Pepper,
  ...
  max:    { name: 'Max',    breed: 'Labrador', shortBreed: 'Labrador', age: '3y', gender: 'M', weight: '65 lb', dist: '5.2 mi', fee: 400, shelter: 'Rose City Rescue', kind: 'dog', color: '#FFE3B0', accent: '#E8A33C', Art: Pet_Max,
    bio: "Reigning champion of the tennis-ball world cup. Will retrieve until the heat death of the universe.",
    traits: ['High energy', 'Fetch obsessed', 'Loves water', 'Trained'] },
};
